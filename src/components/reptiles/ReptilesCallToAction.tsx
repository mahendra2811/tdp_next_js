...
export default function ReptilesCallToAction() {
  return (
    <section className="py-20 bg-gradient-to-r from-primary/90 to-primary text-white shadow-xl my-16">
      <div className="container max-w-5xl mx-auto px-4 text-center">
        <p className="text-sm uppercase tracking-wider mb-3 opacity-90">Call To Action</p>
        
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
          Ready For Unforgettable Desert Reptile Exploration!
        </h2>
