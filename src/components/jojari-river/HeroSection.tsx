  ...
  return (
    <section className="relative h-[80vh] min-h-[600px] w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src={info.heroImage}
          alt={language === 'en' ? 'Jojari River' : 'जोजारी नदी'}
          fill
          priority
      ...
      <div className="relative h-full flex items-center">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8">{info.subtitle}</p>

            <div className="flex flex-wrap gap-4">
              <Link href={info.aboutButtonLink}>
                <button className="bg-white text-gray-900 hover:bg-gray-100 px-6 py-3 rounded-md font-medium transition-colors">
                  {info.aboutButtonText}
                </button>
              </Link>
