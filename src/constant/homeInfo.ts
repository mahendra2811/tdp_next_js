export const homeInfo = {
  ...
  popularDestinations: {
    ...
    description: "Uncover Hidden Gems: Sharvan's Lens Reveals the Beauty of Rajasthan's Best-Kept Secrets, from Ancient Forts to Enchanting Desert Landscapes.",
    destinations: [
      {
        id: "dhawa-doli",
        location: "Jodhpur",
  ...
  packages: {
    ...
    packages: [
      {
        title: "Dhawa-Doli wildlife Santuary",
        description: "Discover the pristine allure of Dhawa Doli Wildlife Sanctuary, where nature's symphony unfolds amidst breathtaking landscapes. Immerse yourself in the sanctuary's rich biodiversity, a testament to conservation efforts championed by Sharvan Patel.",
  ...
  gallery: {
    ...
    description: "Explore the vibrant tapestry of Rajasthan's landscapes and culture in our Gallery, where every image is a moment captured through Sharvan's lens, unveiling the beauty and authenticity of the Thar Desert.",
    images: [
  ...
  photographerGallery: {
    subtitle: "Photo Gallery",
    title: "",
    description: "Journey through the lens of Sharvan Patel: A Visual Chronicle of His Exploration in Every Frame.",
    images: [
