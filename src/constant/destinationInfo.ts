  ...
  destinations: [
    {
      ...
      description:
        'Explore the serene landscapes and diverse wildlife of this hidden gem in Jodhpur.',
    ...
    },
    {
      ...
      title: 'GADISAR LAKE',
      description:
        'Laser Water Show at Gadisar Lake is one of the first and largest Laser Water Show',
    ...
    },
    {
      ...
      description:
        'This exhibit is primarily to pay respect to all the soldiers who took part and lost their lives in the 1965 India-Pakistan war and the 1971 Longewala battle',
    ...
    },
    {
      ...
      description:
        'The Akal Wood Fossil Park is a 21-hectare preserved area that lies about 17 km from Jaisalmer',
    ...
    },
    {
      ...
      description:
        'Immerse yourself in the magical, peaceful passing of dawn, as the desert sky shifts from starlit darkness to rich golden hues.',
