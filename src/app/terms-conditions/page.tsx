      ...
      <div className="min-h-screen">
        ...
        <div className="container max-w-4xl mx-auto px-4 py-12">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-4">
              Please read these terms and conditions carefully before using the Thar Desert
              Photography website.
            </p>
            ...
            <p className="mb-4">
              ...
              website, including all pages within this website (collectively referred to herein
              below as this "Website"). These Terms apply in full force and effect to your use of
            ...
            <p className="mb-4">
              ...
              these Terms, Thar Desert Photography and/or its licensors own all rights to the
              intellectual property and material contained in this Website, and all such rights are
              reserved.
            </p>
            ...
            <p className="mb-4">
              <strong>
                You are strictly prohibited from copying, reproducing, distributing, publishing,
                displaying, performing, modifying, creating derivative works, transmitting, or in
                any way exploiting any part of our content without obtaining prior written
                permission from Thar Desert Photography.
              </strong>{' '}
              Unauthorized use of our content may violate copyright, trademark, and other applicable
            ...
            <p className="mb-4">
              ...
              respect to Your Content, by displaying it, you grant Thar Desert Photography a
              non-exclusive, worldwide, irrevocable, royalty-free, sublicensable license to use,
            ...
            <p className="mb-4">
              ...
              Thar Desert Photography reserves the right to remove any of Your Content from this
            ...
            <p className="mb-4">
              This Website is provided "as is," with all faults, and Thar Desert Photography makes
            ...
            <p className="mb-4">
              In no event shall Thar Desert Photography, nor any of its officers, directors and
              ...
              and Thar Desert Photography, including its officers, directors and employees shall not
            ...
            <p className="mb-4">
              You hereby indemnify to the fullest extent Thar Desert Photography from and against
            ...
            <p className="mb-4">
              Thar Desert Photography is permitted to revise these Terms at any time as it sees fit,
            ...
            <p className="mb-4">
              ...
              constitute the entire agreement between Thar Desert Photography and you in relation to
              your use of this Website, and supersede all prior agreements and understandings with
              respect to the same.
            </p>
            ...
            <p className="mb-4">
              ...
              All disputes, claims, controversies, or differences arising out of or in connection
              with these Terms shall be subject to the exclusive jurisdiction of the courts in
              Jodhpur, Rajasthan, India. By using our website, you consent to the jurisdiction and
            ...
            <h3 className="text-xl font-semibold mt-8 mb-4">12. Educational Use of Information</h3>

            <p className="mb-4">
              Thar Desert Photography may use customer information for educational purposes, which
              may include case studies, research, and training materials. Any such use will be done
              in a manner that protects your privacy and complies with applicable data protection
              laws. By using our website and services, you acknowledge and consent to such
              educational use of your information.
            </p>
          </div>
        </div>
      </div>
